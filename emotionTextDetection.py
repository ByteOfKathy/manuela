...
happyResponses = ["That's great! I'm happy for you!", "I'm glad you're feeling happy!", "I'm glad you're feeling good!"]
sadResponses = ["Keep your chin up, it'll be alright!", "I'm sorry to hear that. That must be really upsetting. I'm here for you!", "I'm sorry about that. Everything will be alright!"]
madResponses = ["I'm sorry to hear that. That must be frustrating. I'm here for you!", "I'm sorry about that. I hope you feel better soon!"]
fearResponses = ["I can see how you feel worried. It's okay, I'm here for you!", "I'm sorry to hear that. I hope you feel better soon!", "I'm sorry about that. I hope you feel better soon!"]
surpriseResponses = ["Oh, that was unexpected!", "Wow, that's surprising!", "I'm surprised by that!"]
disgustResponses = ["I'm sorry to hear that. That must have been icky. I'm here for you!", "I'm sorry about that. I hope you feel better soon!"]
...
def respond_to_emotion(emotion: str):
    ...
    if correct_response.lower() == "yes":
        ...
        elif emotion == "Fear": tr.tts(random.choice(fearResponses))
        elif emotion == "Surprise": tr.tts(random.choice(surpriseResponses))
        elif emotion == "Disgust": tr.tts(random.choice(disgustResponses))
        elif emotion == "Neutral": tr.tts(random.choice(neutralResponses))
        else:
